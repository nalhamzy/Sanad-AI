...
export async function createThawaniSession({
  ...
  // Per-request override of the public base URL — the caller can pass
  // `https://${req.get('host')}` so links always resolve back to the
  // origin that initiated the payment, even if PUBLIC_BASE_URL on the
