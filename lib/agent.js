...
- Any collecting/reviewing reply → unified **✅ تأكيد وأرسل / ➕ سأرسل المزيد / ✕ إلغاء الطلب** buttons
    ...
    messages.push({
      ...
      content:
        ...
        (unmatchedList.length
          ...
          : '') +
        (remaining.length
          ? `  • Final line — ask "is your file complete?". DO NOT name a "next" doc. e.g. "Is your file complete?" / "هل اكتمل ملفك؟ تأكيد وأرسل، أو أرسل المزيد."\n`
