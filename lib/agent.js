...
async function handleButtonIntent({ session_id, state, btn_id, attachment, citizen_phone, trace }) {
  ...
  if (btn_id === 'service:cancel') {
    if (state.status === 'idle') {
      // Deterministic Arabic reply (trace +96892888715 #1358 had the LLM
      // produce English here — jarring mid-Arabic conversation). No
      // buttons since there's nothing actionable.
