...
// Default vision model: Sonnet 4.5 (independent of the chat model).
// Opus per image is ~3× slower and ~5× cost; doc classification accuracy
// gain over Sonnet is marginal. Override per-deploy via ANTHROPIC_VISION_MODEL
// if a specific use case needs Opus for vision specifically.
const ANTHROPIC_MODEL_VL = process.env.ANTHROPIC_VISION_MODEL || 'claude-sonnet-4-5';
