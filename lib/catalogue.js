...
export const LAUNCH_SERVICES = {
  ...
  'mulkiya_renewal': {
    match_keywords: ['mulkiya','vehicle registration','car registration','renew vehicle','renew car','ملكية','تجديد الملكية','تجديد ملكية المركبة','بدل فاقد سند ملكية','بدل فاقد الملكية','سند ملكية'],
    entity_en:'Royal Oman Police', entity_ar:'شرطة عمان السلطانية',
